...
frame_super = [25+4, 56+4]
frame_brace = 43

frame1_link2_n = 4      # 每节分几小节
frame1_x_add = np.r_[4:4+35:5/frame1_link2_n, 4+35, 4+35+6:4+35+6+50:5/frame1_link2_n, 4+35+6+50]
...
for i, j in node.iterrows():
    if j['x'] >= frame1_x[-2] and j['y'] > 0:
        mct_file.write(f"{i}, {j['x']}, {j['y'] * support_d_2/support_d}, {j['z']}\n")
    else:
