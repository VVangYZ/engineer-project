...
# 大斜撑
for x in wl:
    n1 = node_frame[(node_frame['z'] == support_hl[-1]) &
                    (node_frame['y'] == dl[0]) & (node_frame['x'] == x)]
...
mct_file = open(rf'IO\{filename}_{t2[2:]}.mct', 'w+')

# 常规信息
with open(rf'IO\{usual_file}') as f:
